...
const makeIcon = (symbol) => ({ className = '', size = 16 }) => createElement('span', { className: `inline-flex items-center justify-center ${className}`, style: { width: size, height: size }, 'aria-hidden': true }, symbol)
